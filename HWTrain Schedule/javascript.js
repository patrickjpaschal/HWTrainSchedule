...
dataRef.ref().on(
  ...
  function(childSnapshot) {
    ...
    $(".contents").append(
      "<th scope='row'><td scope='cols'  class='welsl'>" +
        childSnapshot.val().name +
        "</td><td scope='cols' class='dTrain1'>" +
        childSnapshot.val().destiny +
        "</td><td scope='cols' class='freqTrain1'>" +
        childSnapshot.val().frequency +
        "</td><td scope='cols' class='next1'>" +
        childSnapshot.val().first +
        "</td><td scope='cols' class='mins'>" +
        childSnapshot.val().frequency +
        "</td></th>"
    );
  },
